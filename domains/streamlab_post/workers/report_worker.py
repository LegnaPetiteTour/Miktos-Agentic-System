...
class ReportWorker:
    ...
    def _render_html(self, payload: dict, report_path: Path) -> str:
        ...
        fr_word_count = int(payload.get("fr_word_count", 0))
        ...
        fr_transcript_section = _render_transcript_section(
            fr_transcript_path, fr_word_count, [],
            title="FR Transcript Preview",
        )
